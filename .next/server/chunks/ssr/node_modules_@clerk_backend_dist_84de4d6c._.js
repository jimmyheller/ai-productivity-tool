...
"[project]/node_modules/@clerk/backend/dist/chunk-RHCGRPND.mjs [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/cookie/dist/index.js [ssr] (ecmascript)");
...
function parseErrors(data) {
    if (!!data && typeof data === "object" && "errors" in data) {
        ...
        return errors.length > 0 ? errors.map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$chunk$2d$QRMWD6KF$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["parseError"]) : [];
    }
    return [];
}
function withLegacyRequestReturn(cb) {
    return async (...args)=>{
        ...
        if (errors) {
            const error = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$chunk$2d$QRMWD6KF$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["ClerkAPIResponseError"](statusText || "", {
                data: [],
                status,
                clerkTraceId,
                retryAfter
...
function signedInAuthObject(authenticateContext, sessionToken, sessionClaims) {
    ...
    return {
        ...
        getToken,
        has: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$chunk$2d$37B446K4$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["createCheckAuthorization"])({
            orgId,
            orgRole,
            orgPermissions,
            userId,
...
var buildUrl = (_baseUrl, _targetUrl, _returnBackUrl, _devBrowserToken)=>{
    ...
    if (_devBrowserToken && baseUrl.hostname !== res.hostname) {
        res.searchParams.set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RHCGRPND$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["constants"].QueryParameters.DevBrowser, _devBrowserToken);
    }
    return res.toString();
};
...
var decorateObjectWithResources = async (obj, authObj, opts)=>{
    ...
    const { sessions, users, organizations } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RHCGRPND$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["createBackendApiClient"])({
        ...opts
    });
...
"[project]/node_modules/@clerk/backend/dist/jwt/index.mjs [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function encodeJwtData(value) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["base64url"].stringify(encoded, {
        pad: false
    });
}
async function signJwt(payload, key, options) {
    ...
    const encoder = new TextEncoder();
    const algorithm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["getCryptoAlgorithm"])(options.algorithm);
    if (!algorithm) {
        return {
            errors: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$5JS2VYLU$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["SignJWTError"](`Unsupported algorithm ${options.algorithm}`)
            ]
        };
    }
    const cryptoKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["importKey"])(key, algorithm, "sign");
    ...
    try {
        const signature = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["runtime"].crypto.subtle.sign(algorithm, cryptoKey, encoder.encode(firstPart));
        const encodedSignature = `${firstPart}.${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["base64url"].stringify(new Uint8Array(signature), {
            pad: false
        })}`;
        return {
        ...
        return {
            errors: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$5JS2VYLU$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["SignJWTError"](error?.message)
            ]
        };
    }
}
// src/jwt/index.ts
var verifyJwt2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$P263NW7Z$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["withLegacyReturn"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["verifyJwt"]);
var decodeJwt2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$P263NW7Z$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["withLegacySyncReturn"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["decodeJwt"]);
var signJwt2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$P263NW7Z$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["withLegacyReturn"])(signJwt);
var hasValidSignature2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$P263NW7Z$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["withLegacyReturn"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AT3FJU3M$2e$mjs__$5b$ssr$5d$__$28$ecmascript$29$__["hasValidSignature"]);
;
...
//# sourceMappingURL=node_modules_%40clerk_backend_dist_84de4d6c._.js.map