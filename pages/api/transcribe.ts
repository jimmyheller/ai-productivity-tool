...
// Define types for formidable callback parameters
...
type FormidableFiles = { [key: string]: FormidableFile | FormidableFile[] };
type FormidableError = Error | null;
...
async function handler(req: NextApiRequest, res: NextApiResponse, userId: string) {
    ...
    return new Promise<void>((resolve) => {
        ...
        form.parse(req, async (err: FormidableError, fields: FormidableFields, files: FormidableFiles) => {
            if (err) {
